...
class InstagramHashtagActor(ApifyActor):
    ...
    def process_documents(self, documents: List, **kwargs) -> List:
        ...
        Instagram hashtag searches benefit from having location data available
        before user author enrichment (geocoding uses body text which doesn't
        depend on profile data).
        """
